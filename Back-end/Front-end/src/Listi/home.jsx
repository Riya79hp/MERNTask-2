...
const PostComponent = () => {
  ...
  const fetchPosts = async () => {
    ...
    try {
      ...
      if (id) {
        const userResponse = await axios.post("http://localhost:4500/getuname", { id });
      ...
      if (id) {
        const userResponse = await axios.post("http://localhost:4500/myacc/signup/authenticateuser", { query: id });
  ...
  const handleCreatePost = async () => {
    ...
    try {
      const response = await axios.post('http://localhost:4500/create', { content, id });
